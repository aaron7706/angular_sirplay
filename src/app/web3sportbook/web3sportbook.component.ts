...
@Component({
  selector: 'app-web3sportbook',
  templateUrl: './web3sportbook.component.html',
  styleUrls: ['./web3sportbook.component.css']
})
export class Web3sportbookComponent implements OnInit {

  typingElement: any;
  typeArray: string[] = ["Sportsbook" ,"Casino"];
  index = 0;
  isAdding = true;
  typeIndex = 0;
