...
@Component({
  selector: 'app-decentralized',
  templateUrl: './decentralized.component.html',
  styleUrls: ['./decentralized.component.css']
})
export class DecentralizedComponent implements OnInit {

  typingElement: any;
  typeArray: string[] = ["Casino" ,"eSport" ,"Sport Betting"];
  index = 0;
  isAdding = true;
  typeIndex = 0;
